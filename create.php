...
// $sql = "insert into questions(question,answer,pointss) values('$quest','$answer','$point')";

// $get_quest_id = "select id from questions ORDER BY id DESC LIMIT 1";
// $user_id = "select id from users where username=".$_SESSION["username"]." LIMIT 1";
// $insert_new = "INSERT INTO whois(user_id,quest_id) VALUES('$user_id', '$get_quest_id')";
// mysqli_query($db,$sql);
...
<title>KeyNote Studio Jeopardy Template</title>
<meta name="description" content=", As a young child, I toured Europe with my sister, Nannerl, and my father, Leopold., I worked for a rich family name Esterhazy., I lost my hearing by the age 30, yet I composed some of my greatest works after I lost my hearing., Born in the Baroque era, I composed works like Preludes and Fugues, Inventions, and Sinfonias - all for the harpsichord." />
...
<link rel="icon" href="/media/favicon.ico" type="image/x-icon" />
    ...
    <link rel="canonical" href="/play/keynote-studio" />
    <script src="/static/bc31bd16/js/jquery.min.js"></script>
...
<body>
    ...
    <div id="gameplay">
        <div class="table-row" id="categories">
            <!--
                --><div class="table-cell">
                    <div class="table-cell-inner"><?php echo $t1; ?></div>
                </div><!--
            --><!--
                --><div class="table-cell">
        ...
        <div id="question-grid">
                ...
                <div class="table-row">
                    <!--
                        --><div data-points="100" tabindex="" class="table-cell ">
                ...
                <div class="table-row">
                    <!--
                        --><div data-points="200" tabindex="" class="table-cell ">
                            <div class="table-cell-inner">
                                <h3>200</h3>
                                <div class="answer"> </div>
                                <div class="question"></div>
                ...
                <div class="table-row">
                    <!--
                        --><div data-points="300" tabindex="" class="table-cell ">
                            <div class="table-cell-inner">
                                <h3>300</h3>
                                <div class="answer"></div>
                                <div class="question"> </div>
                ...
                <div class="table-row">
                    <!--
                        --><div data-points="400" tabindex="" class="table-cell ">
                            <div class="table-cell-inner">
                                <h3>400</h3>
                                <div class="answer"></div>
                                <div class="question">
                ...
                <div class="table-row">
                    <!--
                        --><div data-points="500" tabindex="" class="table-cell ">
                            <div class="table-cell-inner">
                                <h3>500</h3>
                                <div class="answer"></div>
                                <div class="question">
        ...
        <div id="teams">
                ...
                <div class="team" style="display:none">
                    <h3 class="name" contenteditable="true">1 команда</h3>
                ...
                <div class="team" style="display:none">
                    <h3 class="name" contenteditable="true">2 команда</h3>
                    <h3 class="points" contenteditable="true">0</h3>
                    <div class="pointer">
                        <span class="plus">+</span>
                        <span class="minus">-</span>
                ...
                <div class="team" style="display:none">
                    <h3 class="name" contenteditable="true">3 команда </h3>
                    <h3 class="points" contenteditable="true">0</h3>
                    <div class="pointer">
                        <span class="plus">+</span>
                        <span class="minus">-</span>
                ...
                <div class="team" style="display:none">
                    <h3 class="name" contenteditable="true">4 команда</h3>
                    <h3 class="points" contenteditable="true">0</h3>
                    <div class="pointer">
                        <span class="plus">+</span>
                        <span class="minus">-</span>
                ...
                <div class="team" style="display:none">
                    <h3 class="name" contenteditable="true">5 команда</h3>
                    <h3 class="points" contenteditable="true">0</h3>
                    <div class="pointer">
                        <span class="plus">+</span>
                        <span class="minus">-</span>
                ...
                <div class="team" style="display:none">
                    <h3 class="name" contenteditable="true">6 команда</h3>
                    <h3 class="points" contenteditable="true">0</h3>
                    <div class="pointer">
                        <span class="plus">+</span>
                        <span class="minus">-</span>
                ...
                <div class="team" style="display:none">
                    <h3 class="name" contenteditable="true">Team 7</h3>
                    <h3 class="points" contenteditable="true">0</h3>
                    <div class="pointer">
                        <span class="plus">+</span>
                        <span class="minus">-</span>
                ...
                <div class="team" style="display:none">
                    <h3 class="name" contenteditable="true">Team 8</h3>
                    <h3 class="points" contenteditable="true">0</h3>
                    <div class="pointer">
                        <span class="plus">+</span>
                        <span class="minus">-</span>
                ...
                <div class="team" style="display:none">
                    <h3 class="name" contenteditable="true">Team 9</h3>
                    <h3 class="points" contenteditable="true">0</h3>
                    <div class="pointer">
                        <span class="plus">+</span>
                        <span class="minus">-</span>
                ...
                <div class="team" style="display:none">
                    <h3 class="name" contenteditable="true">Team 10</h3>
                    <h3 class="points" contenteditable="true">0</h3>
                    <div class="pointer">
                        <span class="plus">+</span>
                        <span class="minus">-</span>
                ...
                <div class="team" style="display:none">
                    <h3 class="name" contenteditable="true">Team 11</h3>
                    <h3 class="points" contenteditable="true">0</h3>
                    <div class="pointer">
                        <span class="plus">+</span>
                        <span class="minus">-</span>
                ...
                <div class="team" style="display:none">
                    <h3 class="name" contenteditable="true">Team 12</h3>
                    <h3 class="points" contenteditable="true">0</h3>
                    <div class="pointer">
                        <span class="plus">+</span>
                        <span class="minus">-</span>
                ...
                <div class="team" style="display:none">
                    <h3 class="name" contenteditable="true">Team 13</h3>
                    <h3 class="points" contenteditable="true">0</h3>
                    <div class="pointer">
                        <span class="plus">+</span>
                        <span class="minus">-</span>
                ...
                <div class="team" style="display:none">
                    <h3 class="name" contenteditable="true">Team 14</h3>
                    <h3 class="points" contenteditable="true">0</h3>
                    <div class="pointer">
                        <span class="plus">+</span>
                        <span class="minus">-</span>
                ...
                <div class="team" style="display:none">
                    <h3 class="name" contenteditable="true">Team 15</h3>
                    <h3 class="points" contenteditable="true">0</h3>
                    <div class="pointer">
                        <span class="plus">+</span>
                        <span class="minus">-</span>
                ...
                <div class="team" style="display:none">
                    <h3 class="name" contenteditable="true">Team 16</h3>
                    <h3 class="points" contenteditable="true">0</h3>
                    <div class="pointer">
                        <span class="plus">+</span>
                        <span class="minus">-</span>
        ...
        <div id="question-modal" class="modal-wrapper">
            <div id="question-modal-table">
                <div id="continue-button"><span><kbd>Кері</kbd></span></div>
                <div id="question-title"></div>
                <div id="answer-button"><span><kbd>Дұрыс жауабын білу </kbd></span></div>
            </div>
            <div class="modal2">
    ...
    <div id="options" class="modal-wrapper">
        <div class="modal">
            ...
            <h1>Интеллектуалды ойынға қош келдіңіздер!!!</h1>
            <select>
                <option value="1">1 команда</option>		
                <option value="2">2 команда</option>
                <option value="3">3 команда</option>
                <option value="4">4 команда</option>
                <option value="5">5 команда</option>
                <option value="6">6 команда</option>
                <option value="7">7 команда</option>
                <option value="8">8 команда</option>
                <option value="9">9 команда</option>
                <option value="10">10 команда</option>	
                <option value="11">11 команда</option>
                <option value="12">12 команда</option>	
                <option value="13">13 команда</option>	
                <option value="14">14 команда</option>	
                <option value="15">15 команда</option>	
                <option value="16">16 команда</option>	
            </select>
            <input class="submit" type="button" id="submit" value="Баста" onclick="game.init()" />
            <div id="reset-all" style="display:none">
                <a href="">Reset Scores</a>
            </div>
            <p id="fullscreen" style="margin-top:20px; display:none" align="center"> <kbd id="windows" style="display:none">F11</kbd> </p>
            <script>
